  ...
  return (
    <div>
     <div className='flex flex-col md:flex-row lg:flex-row items-center 
      justify-center md:justify-evenly lg:justify-evenly my-24 max-w-7xl md:max-w-4xl lg:max-w-5xl mx-auto  '>
      <div className='relative bg-light-gray mb-9 md:mb-0 lg:mb-0 h-40 w-64 mt-12 '>
      ...
      <div className='relative bg-light-gray mb-7 md:mb-0 lg:mb-0 h-40  w-64 mt-12'>
     ...
     <div className='flex flex-col lg:flex-row items-center justify-center lg:justify-evenly bg-oranger-bg mx-auto max-w-2xl lg:max-w-4xl h-700 lg:h-400'>
     <div className=' w-600 h-400 '>
        <img className='mt-28 mb-0 h-300' src={speaker} alt='speaker' />
      </div>
      <div className=' mt-12 flex flex-col lg:mt-32 items-center lg:items-start'>
     ...
     <div className='flex mx-auto max-w-2xl lg:max-w-4xl my-12 relative'>
      <div className='absolute  top-10 md:top-24 lg:top-24 left-2 pl-36 md:pl-80 lg:pl-80 transform -translate-x-1/2 -translate-y-1/2'>
     ...
     <div className='flex flex-col md:flex-row lg:flex-row mx-auto  max-w-2xl lg:max-w-4xl my-12 gap-4'>
