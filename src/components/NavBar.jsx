...
const NavBar = () => {
  ...
  return (
    <div className=' bg-[black]'>
       <nav className='p-12 mx-auto w-full flex  justify-between  text-[white]'>
        <button onClick={toggleMenu} className='text-white lg:hidden'>☰</button>
        <div className='ml-20 lg:ml-28 font-bold'>audiophile</div>
        ...
        <div className=' ml-24  md:ml-80 lg:ml-24'>
